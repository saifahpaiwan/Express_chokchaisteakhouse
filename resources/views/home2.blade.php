            ...
            <tbody>
                <tr>  
                    ...
                    <td class="text-center white-space menu-vv">
                        <a href="#subs{{$row1['productSubid']}}"> 
                            <div class="white-space">{{$row1['productSubname']}}</div>
                        </a>
                    </td>  
                    <?php $n++; ?>
                    @endforeach 
     ...
     <section class="content-wrap section gradient" id="">
        <div class="container"> 
            <div class="row hero-content-1 text-left mb-3">
                <div class="col-12"> 
                    <a href="https://www.myinstants.com/instant/esiiyngnaakh-m-w-10-43792/?utm_source=copy&utm_medium=share"> OK </a>
                    <div class="tab-content"> 
                        @foreach($data['QueryproductItems'] as $row1)  
                            <div class="" id="subs{{$row1['productSubid']}}">
                                <h4 class="text-dark"> {{$row1['productSubname']}} </h4>
